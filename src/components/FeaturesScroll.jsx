...
import { Mic, Clock, CheckCheck, User, MessageCircle, Heart, Star, Home } from 'lucide-react';
...
const FeaturesScroll = () => {
  ...
  return (
    <section ref={containerRef} className="relative h-[300vh] bg-[#FDFDFD]">
      <div className="sticky top-0 h-[100dvh] w-full flex flex-col lg:flex-row overflow-hidden pt-8 lg:pt-0">
        
        {/* Left Side: Text Content */}
        <div className="relative w-full h-[40dvh] lg:h-full lg:w-1/2 flex flex-col justify-center px-6 lg:pl-24 lg:pr-16 z-20 pointer-events-none">
          {features.map((feature, idx) => (
            <motion.div 
              key={idx}
              style={{ opacity: feature.opacity, y: feature.y }}
              className="absolute inset-x-6 lg:inset-x-0 top-1/2 -translate-y-1/2 lg:pl-24 space-y-2 sm:space-y-3 lg:space-y-6 text-center lg:text-left"
            >
        ...
        <div className="relative w-full h-[60dvh] lg:h-full lg:w-1/2 flex justify-center lg:justify-end items-end lg:items-center z-10 pointer-events-auto perspective-[1200px] lg:pr-24">
          
          {/* Phone Frame */}
          <div className="absolute bottom-0 lg:relative lg:bottom-auto w-[300px] lg:w-[320px] h-[600px] lg:h-[650px] bg-black rounded-t-[40px] lg:rounded-[45px] rounded-b-none lg:rounded-b-[45px] border-[8px] lg:border-[10px] border-gray-900 border-b-0 lg:border-b-[10px] shadow-2xl overflow-hidden flex flex-col shrink-0 transform  origin-bottom lg:origin-center scale-[0.65] sm:scale-75 md:scale-90 lg:scale-100">
            ...
            <motion.div style={{ opacity: opacity0 }} className="absolute inset-0 bg-[#FAFAFA] flex items-center justify-center p-4">
              <div className="bg-white rounded-3xl p-6 shadow-xl w-full border border-gray-100">
            ...
            <motion.div style={{ opacity: opacity1 }} className="absolute inset-0 bg-gray-900 overflow-hidden">
              ...
              <div className="absolute inset-0 p-5 pt-16 flex flex-col justify-between backdrop-blur-md bg-black/10">
                
                {/* Prompt Card (Smaller) */}
                <div className="bg-white rounded-3xl p-5 shadow-2xl w-full mt-4">
                  <p className="text-xs text-gray-500 mb-2">My ideal partnership looks like...</p>
                  <p className="text-base font-bold text-black leading-tight mb-4">
                ...
                {/* Interests Section */}
                <div className="mt-auto mb-6 w-full z-10">
                  <h3 className="text-white font-bold text-lg mb-3 drop-shadow-md">Interests</h3>
                  <div className="flex flex-wrap gap-2">
                    <div className="px-3 py-1.5 bg-white text-black text-sm font-semibold rounded-md flex items-center gap-1 shadow-sm">
                      <CheckCheck size={14}/> Travelling
                    </div>
                    <div className="px-3 py-1.5 bg-white text-black text-sm font-semibold rounded-md flex items-center gap-1 shadow-sm">
                      <CheckCheck size={14}/> Books
                    </div>
                    <div className="px-3 py-1.5 bg-white text-black text-sm rounded-md shadow-sm">Music</div>
                    <div className="px-3 py-1.5 bg-white text-black text-sm rounded-md shadow-sm">Dancing</div>
                    <div className="px-3 py-1.5 bg-white text-black text-sm rounded-md shadow-sm">Modeling</div>
                  </div>
                  <div className="flex justify-end">
                    <button className="mt-4 px-5 py-2 bg-white text-black font-bold rounded-xl shadow-lg text-sm">
                      Show More
                    </button>
                  </div>
                </div>
                ...
                {/* Action Buttons */}
                <div className="flex justify-center items-center gap-4 mb-20 w-full z-10">
                  <button className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-xl text-orange-500 text-4xl font-bold pb-1">
                    ×
                  </button>
                  <button className="w-16 h-16 bg-green-500 rounded-2xl flex items-center justify-center shadow-xl text-white">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10"><path d="M12 2l2.4 7.6L22 12l-7.6 2.4L12 22l-2.4-7.6L2 12l7.6-2.4L12 2z"/></svg>
                  </button>
                  <button className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-xl text-purple-600">
            ...
            <motion.div style={{ opacity: opacity2 }} className="absolute inset-0 bg-white flex flex-col pt-12 pb-20 ">
              ...
              <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
                ...
                <div className="flex flex-col items-end space-y-1">
                  ...
                  <div className="flex items-center space-x-1 text-gray-400">
                    <span className="text-[10px]">3:12 PM</span>
                    <CheckCheck size={12} className="text-gray-400" />
                  </div>
                </div>
              ...
              {/* Chat Input */}
              <div className="absolute bottom-20 inset-x-0 px-4 py-3 bg-white flex gap-2 border-t border-gray-50 z-10">
                ...
                <button className="w-11 h-11 border border-gray-200 rounded-2xl flex items-center justify-center">
                  <Mic size={18}/>
                </button>
              </div>
            </motion.div>
